!function (e, t) {
    ...
    e(document).ready(function () {
        ...
        e("input[name=cht_custom_color]").keyup(function (t) {
            ...
            if (t.preventDefault(), !e(this).hasClass("icon") || !e(this).hasClass("active")) {
                ...
                if(!e(this).hasClass("close-btn-set")) {
                    ...
                    e.ajax({
                        ...
                        dataType: "json",
                        url: ajaxurl,
                        data: {action: "remove_social", nonce_code: cht_nonce_ajax.cht_nonce, social: s},
                        beforeSend: function (e) {
                        },
                        success: function (t) {
                            t && (c.remove(), i.remove(), e(".icon-sm").each(function () {
                                e(this).data("social");
                                check_for_close_btn();
                            }))
                        },
            ...
            window.open("https://premio.io/downloads/chaty/#faq", "_blank")
        ...
        function d() {
            var t, o, a = !1;
            h() ? (0 === e(".js-chanel-desktop:checked").length && (t = !1), 1 === e(".js-chanel-desktop:checked").length && (t = e('.icon[data-title="' + e(".js-chanel-desktop:checked").attr("data-type") + '"]').html()), e(".js-chanel-desktop:checked").length > 1 && (t = l, a = !0)) : (0 === e(".js-chanel-mobile:checked").length && (o = !1), 1 === e(".js-chanel-mobile:checked").length && (o = e('.icon[data-title="' + e(".js-chanel-mobile:checked").attr("data-type") + '"]').html()), e(".js-chanel-mobile:checked").length > 1 && (o = l, a = !0)), c = t, s = o, h() ? p(c, a) : p(s, a)
        }

<?php
    ...
    //echo "search.php q: ".$_GET['q']."<br/>";

    if (isset($_GET['q'])) {
        //echo "search.php html_entity_decode q : ".html_entity_decode($_GET['q'])."<br/>";
        //echo "search.php strip_tags q : ".strip_tags(html_entity_decode($_GET['q']))."<br/>";
        //echo "search.php preg_replace q : ".preg_replace('/\[^a-zA-Z0-9"@._-\s\]/', '', 'abhi1302')."<br/>";
        $q = preg_replace('/\[^a-zA-Z0-9"@._-\s\]/', '', strip_tags(html_entity_decode($_GET['q'])));
        //echo "search.php q before search: ".$q."<br/>";
        $results = $search->go($q);
    }

<?php
    ...
    $app->page->canonical = 'http://www.crushit.fit/conduct';
        ...
        <article class='bbcode body' itemscope itemtype="http://schema.org/Article">
            ...
            <div itemprop='articleBody' class='articleBody width-center'>
                ...
                <ul>
                    ...
                    <li>I will not ‘spam’ other CrushIt!! members by posting the same message multiple times or posting a message that is unrelated to the discussion.</li>
                    <li>As the CrushIt!! community’s first language is English, I will always post contributions in English to enable all to understand</li>
                    <li>I will not use CrushIt!! to advertise products or services for profit or gain.</li>

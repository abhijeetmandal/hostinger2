...
?>
                <div class='row header'>
                    <img src="../files/images/logo_landing.png" alt="Crush It!! - The Next Generation of Fitness Training">
                </div>
<?php
...
?>
                <div class='row landing_blurb'>
                    <h1>Want to have the most aesthetically pleasing and impressive physique ever? Discover how Machine Learning can make exercising a fun activity. Get your body some exercise with CrushIt!!</h1>
                </div>
                <div class='row landing'>
                    <div class='col span_15'>
                        <section class='row fluid features'>
                            <a href='/demo' class='clr'>
                                <div class='col span_5'>
                                    <div class='circle'><i class='icon-eye'></i></div>
                                </div>
                                <div class='col span_19'>
                                    <h2>Demo</h2>
                                    <span class='blurb'>
                                        <strong class='white'>Checkout (need access to camera)</strong><br/>We are trying a new technology of Machine Learning to shape and improve fitness of an individuals. 
                                    </span>
                                </div>
                            </a>

...
?>
    ...
    <p>
        <h2 class='no-margin'>₹10 or more</h2>
        Get yourself listed on our donator hall of fame.
    </p>
    <p>
        <h2 class='no-margin'>₹50 or more</h2>
    ...
    <p>
        <h2 class='no-margin'>₹100 or more</h2>
        As well as all perks listed above you will also be able to show off your support with a stylish CrushIt!! T-shirt.
    </p>
    <br/>

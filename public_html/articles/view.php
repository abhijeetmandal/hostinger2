<?php
    ...
    if ($article && !$myArticle) {
        ...
        $app->page->desc = "Learn about " . $app->page->title . " with our range of Body Building tutorials and articles. Join our Body Building community and test your skills.";

        $app->page->canonical = 'https://www.crushit.fit/articles/'.$article->slug;
        ...
        if (isset($article->thumbnail) && $article->thumbnail) {
            $app->page->meta['og:image'] = "https://www.crushit.fit/images/200/4:3/{$article->thumbnail}.jpg";

...
<?php
    if (isset($_GET['edit-categories'])) {
        include('../../files/elements/gym_editor/edit_categories.php');
    }

    if (isset($_GET['edit'])) {
        if (isset($_GET['form']))
            include('../../files/elements/gym_editor/edit_level_form.php');
        else
            include('../../files/elements/gym_editor/edit_level.php');
    } else {
        include('../../files/elements/gym_editor/level_list.php');
    }
?>

...
class SLIRRequest
{
  ...
  final public function initialize()
  {
    ...
    if (isset($params['i']) && $params['i'] != '' && $params['i'] != '/') {
      ...
      //echo "defaultImagePath1: ".$params['i']." before: ".SLIRConfig::$defaultImagePath ."<br/>";
      $this->__set('i', SLIRConfig::$defaultImagePath);
      //echo "defaultImagePath2: ".$params['i']." after: ".SLIRConfig::$defaultImagePath ."<br/>";
    } else {
...
/slir/w300-h300-c1.1/path/to/image.jpg');
  ...
  private function setPath($path)
  {
    ...
    //echo "path2: ". $this->path."</br>";

    if (!$this->isPathSecure()) {
      // Make sure the image path is secure
        //echo 'Image path may not contain ":", "..", "<", or ">"';
        //die();
      ...
      if (SLIRConfig::$defaultImagePath !== null && !$this->isUsingDefaultImagePath()) {
        ...
        //echo "default: ". SLIRConfig::$defaultImagePath;
        //die();
        return $this->setPath(SLIRConfig::$defaultImagePath);
      } else {
          //echo 'Image does not exist: ' . $this->fullPath();
          //die();
  ...
  {
    //echo "image_path: ". SLIRConfig::$documentRoot ." thispath: ". $this->path."<br/><br/>";
    //echo "realpath1 :" .realpath("./")."</br>";
    //echo "realpath2 :" .realpath("../../../../../")."</br>";
    //echo "documentRoot :" .realpath(SLIRConfig::$documentRoot)."</br>";
    //echo "fullpath :" .realpath(SLIRConfig::$documentRoot.$this->path)."</br><br/>";

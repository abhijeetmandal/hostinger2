...
echo "realpath Mandrill1: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Templates.php';
echo "realpath Mandrill2: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Exports.php';
echo "realpath Mandrill3: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Users.php';
echo "realpath Mandrill4: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Rejects.php';
echo "realpath Mandrill5: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Inbound.php';
echo "realpath Mandrill6: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Tags.php';
echo "realpath Mandrill7: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Messages.php';
echo "realpath Mandrill8: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Whitelists.php';
echo "realpath Mandrill9: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Ips.php';
echo "realpath Mandrill10: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Internal.php';
echo "realpath Mandrill11: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Subaccounts.php';
echo "realpath Mandrill12: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Urls.php';
echo "realpath Mandrill13: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Webhooks.php';
echo "realpath Mandrill14: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Senders.php';
echo "realpath Mandrill15: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Metadata.php';
echo "realpath Mandrill16: ".  realpath(".")."<br/>";
require_once '../../files/vendor/mandrill/Mandrill/Exceptions.php';
echo "realpath Mandrill17: ".  realpath(".")."<br/>";

...
?>       
        <div class='info solution'>
            Want to share your experience? <a href='/forum/level-discussion/<?=strtolower($currentLevel->group);?>-levels/<?=strtolower($currentLevel->group);?>-level-<?=$currentLevel->name;?>/experience'>Visit the experience section</a> in the forum.
        </div>
<?php

...
?>
                        <form id="registration_form" action="?register" method="POST">
                            ...
                            <input type="text" name="reg_mobile" id="reg_mobile" value="<?=isset($_POST['reg_mobile'])?htmlspecialchars($_POST['reg_mobile']):''?>">
                            <div class='hide' id="reg_mobile_suggestion">Suggestion</div>

<?php
    ...
    if (is_numeric($_GET['edit'])) {
        ...
        if (!$challenge) {
            ...
            if (isset($_POST['save'])) {
                $updated = $app->challenges->editChallenge($_GET['edit']);
        ...
        if (isset($_POST['save'])) {
            $id = $app->challenges->newChallenge();

            if ($id !== false) {
                $app->utils->message('Challenge created', 'good');
                $challenge = $app->challenges->getChallengeFromID($id);
            } else {
...
<?php endif; ?>
        <div class='col span_6'>
            ...
            <div class='select-menu' data-id="category" data-value="">
                ...
                <ul>
<?php
    $groups = $app->challenges->getGroups();

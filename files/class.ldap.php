<?php
    ...
    class ldap {
        ...
        public function createUser($user_id, $username, $password) {
            //$log = new log($this);
//            $log->add("users", "class.ldap.php createUser() config: $this->config");
//            $log->add("users", "class.ldap.php createUser() user_id: $user_id");
//            $log->add("users", "class.ldap.php createUser() username: $username");
            $username = $this->escapeUsername($username);
//            $log->add("users", "class.ldap.php createUser() username: $username");
//            $log->add("users", "class.ldap.php createUser() password: $password");
//            $log->add("users", "class.ldap.php createUser() connection: $this->connection");
            if (!$username) return false;
...
//            $log->add("users", "class.ldap.php createUser() dn: $dn");
//            $log->add("users", "class.ldap.php createUser() info: $info");

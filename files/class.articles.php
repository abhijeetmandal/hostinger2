    ...
    class articles {
        ...
        public function getCategories($parent=null, $news=true) {
            if ($parent == null && $news == false) {
                ...
                //echo $this->app->cache->get('articles_categories', 60) ;
            ...
            if ($parent == null && $news == false) {
                ...
                $this->app->cache->set('articles_categories', json_encode($result));
            }
        ...
        public function getArticles($cat_id=null, $limit=2, $page=1) {
            //echo "getArticle";
            //$log=new log($this);
            //$log->add("users", "class.articles.php getArticle()");
            ...
            //$log->add("users", "class.articles.php getArticle() sql: $sql");
            ...
            //$log->add("users", "class.articles.php getArticle() cat_id: $cat_id");
            //$log->add("users", "class.articles.php getArticle() uid: ". $this->app->user->uid);
            //$log->add("users", "class.articles.php getArticle() limit1:". ($page-1)*$limit);
            //$log->add("users", "class.articles.php getArticle() limit2:". $limit);
            //$log->add("users", "class.articles.php getArticle() PARAM_INT: ". PDO::PARAM_INT);

<?php
    ...
    //echo "2.1) init start <br/>";
    #header("Access-Control-Allow-Headers: Authorization, Content-Type");
    #header("Access-Control-Allow-Origin: *");
    #header('content-type: application/json; charset=utf-8');

    session_save_path('/opt/alt/php72/var/lib/php/session'); // /opt/alt/php72/var/lib/php/session
    ...
    $csp_rules = "
        default-src 'self' https://*.citruspay.com https://crushit.fit https://www.crushit.fit:8080 wss://www.crushit.fit:8080 https://themes.googleusercontent.com https://*.facebook.com https://fonts.gstatic.com https://bam.nr-data.net https://crushit.fit;
        script-src 'self' data: 'unsafe-inline' 'unsafe-eval' https://*.citruspay.com https://*.googleapis.com https://*.google-analytics.com https://www.crushit.fit:8080 https://cdnjs.cloudflare.com https://*.twitter.com https://*.api.twitter.com https://pagead2.googlesyndication.com *.newrelic.com https://www.google.com https://ssl.gstatic.com https://members.internetdefenseleague.org https://netdna.bootstrapcdn.com https://ajax.aspnetcdn.com/ajax/jquery.validate d1l6p2sc9645hc.cloudfront.net https://*.gosquared.com cdn.socket.io d3t63m1rxnixd2.cloudfront.net widget.battleforthenet.com *.newrelic.com https://crushit.fit;
